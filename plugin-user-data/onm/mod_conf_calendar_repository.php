...
define('_do','custom/mod_conf_calendar_repository');
...
function open(){
   ...
   new template('shtml/mod_conf_calendar_repository.shtml',$array_tpl);
}
...
function get_table($mode=0){
   ...
   $cont = 1;
   $dirToScan = '/var/www/html/onm/user/calendar';
   $dirToScanRel = 'user/calendar';
