...
define('_do','custom/mod_conf_file_repository');
...
function open(){
   ...
   new template('shtml/mod_conf_file_repository.shtml',$array_tpl);
}

function get_table($mode=0){
   $tabla = new Table();
   $tabla->addCol(array('type'=>'ro','width'=>'120','sort'=>'int','align'=>'left'),'',i18('_fecha'));
   $tabla->addCol(array('type'=>'ro','width'=>'140','sort'=>'str','align'=>'left'),'',i18('_nombre'));
   $tabla->addCol(array('type'=>'ro','width'=>'50','sort'=>'str','align'=>'center'),'',i18('_estado'));
   $tabla->addCol(array('type'=>'ro','width'=>'70','sort'=>'str','align'=>'left'),'',i18('_tamano'));
   $tabla->addCol(array('type'=>'ro','width'=>'*','sort'=>'str','align'=>'left'),'',i18('_lineas'));
   $data = array();


   $cont = 1;
   $dirToScan = '/var/www/html/onm/user/file_storage_repository';
   $dirToScanRel = 'user/file_storage_repository';
