#!/usr/bin/perl -w
#--------------------------------------------------------------------
# NAME:  linux_dpkg_ssh_script.pl
#
# DESCRIPTION:
# Ejecuta un script en un host remoto mediante SSH 
#
# CALLING SAMPLE:
# linux_dpkg_ssh_script.pl -n localhost [-a pattern] [-v]
# linux_dpkg_ssh_script.pl -n 1.1.1.1 -c "-user=aaa -pwd=bbb" [-a pattern] [-v]
# linux_dpkg_ssh_script.pl -h  : Ayuda
#
# INPUT (PARAMS):
# -n  :  IP remota
# -c  :  Credenciales
...
my $USAGE = <<USAGE;
linux_dpkg_ssh_script.pl. $VERSION
