...
//      $TIPS[]=array(
//         'id_ref' => 'ws_get_csv_view_metrics',          'tip_type' => 'script',
...
//      );
      ...
      $TIPS[]=array(
         'id_ref' => 'generate_report.php',          		'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
         'descr' => '<strong>Generador de informes del sistema</strong><br>'
      );
      $TIPS[]=array(
         'id_ref' => 'linux_app_restore_passive_from_active.pl', 'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
...
//---------------------------------------------------------------------------------------------------------
      ...
      $TIPS[]=array(
         'id_ref' => 'mon_smtp_ext',          'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
...
//---------------------------------------------------------------------------------------------------------
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_app_get_conf_telnet_comtrend_router.pl',      'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_app_get_conf_telnet_cisco_router.pl',      'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_app_check_remote_cfgs.pl',      'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
