...
/*      $TIPS[]=array(
         'id_ref' => 'linux_metric_certificate_expiration_time.pl',          'tip_type' => 'script',
...
*/
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_mysql_var.pl',          'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_mail_loop.pl',          'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_ssh_files_per_proccess.pl',          'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_ssh_files_in_dir.pl',          'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_route_tag.pl',          'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'win32_metric_wmi_core.vbs',          'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
         'descr' => '<strong>OBTIENE LOS VALORES DE LOS DIFERENTES CONTADORES WMI</strong><br>'
      );
      $TIPS[]=array(
         'id_ref' => 'linux_metric_snmp_count_proc_multiple_devices.pl',   'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_mon_dns.pl',   'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_mon_http_uri_response.pl',   'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_mon_imap.pl',   'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_mon_pop3.pl',   'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
      ...
      $TIPS[]=array(
         'id_ref' => 'linux_metric_mon_smtp.pl',   'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
...
/*
      $TIPS[]=array(
         'id_ref' => 'linux_metric_wmi_perfOS.pl',   'tip_type' => 'script',
         'url' => '',      'date' => '',     'tip_class' => 1,
         'name' => 'Descripcion',
