...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_mem_real',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_mem_buffer',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_swap',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_io',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_int',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_cswitches',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_soft_irq',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_cpu_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_load3',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_cpu_raw_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
...
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_cpu2_raw_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>Idle|User|System</strong> a partir de los siguientes atributos de la mib UCD-SNMP-MIB:<br><br><strong>UCD-SNMP-MIB::ssCpuRawIdle.0 (COUNTER):</strong> "idle CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawUser.0 (COUNTER):</strong> "user CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawSystem.0 (COUNTER):</strong> "system CPU time."
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_cpu4_raw_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>Idle|User|System</strong> a partir de los siguientes atributos de la mib UCD-SNMP-MIB:<br><br><strong>UCD-SNMP-MIB::ssCpuRawIdle.0 (COUNTER):</strong> "idle CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawUser.0 (COUNTER):</strong> "user CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawSystem.0 (COUNTER):</strong> "system CPU time."
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_cpu8_raw_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>Idle|User|System</strong> a partir de los siguientes atributos de la mib UCD-SNMP-MIB:<br><br><strong>UCD-SNMP-MIB::ssCpuRawIdle.0 (COUNTER):</strong> "idle CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawUser.0 (COUNTER):</strong> "user CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawSystem.0 (COUNTER):</strong> "system CPU time."
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_cpu16_raw_usage',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>Idle|User|System</strong> a partir de los siguientes atributos de la mib UCD-SNMP-MIB:<br><br><strong>UCD-SNMP-MIB::ssCpuRawIdle.0 (COUNTER):</strong> "idle CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawUser.0 (COUNTER):</strong> "user CPU time."
<strong>UCD-SNMP-MIB::ssCpuRawSystem.0 (COUNTER):</strong> "system CPU time."
',
      ...
      $TIPS[]=array(
         'id_ref' => 'ucd_disk_acc_bytes',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>diskIONRead|diskIONWritten</strong> a partir de los siguientes atributos de la mib UCD-DISKIO-MIB:<br><br><strong>UCD-DISKIO-MIB::diskIONRead (COUNTER):</strong> "The number of bytes read from this device since boot."
<strong>UCD-DISKIO-MIB::diskIONWritten (COUNTER):</strong> "The number of bytes written to this device since boot."
',
      );


      $TIPS[]=array(
         'id_ref' => 'ucd_disk_acc',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>diskIOReads|diskIOWrites</strong> a partir de los siguientes atributos de la mib UCD-DISKIO-MIB:<br><br><strong>UCD-DISKIO-MIB::diskIOReads (COUNTER):</strong> "The number of read accesses from this device since boot."
<strong>UCD-DISKIO-MIB::diskIOWrites (COUNTER):</strong> "The number of write accesses to this device since boot."
',
      );


      $TIPS[]=array(
         'id_ref' => 'ucd_lmsensors_temp',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
         'descr' => 'Mide: <strong>Grados C</strong> a partir de los siguientes atributos de la mib LM-SENSORS-MIB:<br><br><strong>LM-SENSORS-MIB::lmTempSensorsValue (GAUGE):</strong> "The temperature of this sensor in mC."
',
      );


      $TIPS[]=array(
         'id_ref' => 'ucd_lmsensors_volt',	'tip_type' => 'cfg',	'url' => '',
         'date' => '',     'tip_class' => 1,	'name' => 'Descripcion',
