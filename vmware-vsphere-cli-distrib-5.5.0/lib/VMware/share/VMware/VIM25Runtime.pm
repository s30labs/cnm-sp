...
##################################################################################
package ApiHooksCallbackHandler;
our @ISA = qw(ViewBase ApiHooksCallbackHandlerOperations);

VIMRuntime::make_get_set('ApiHooksCallbackHandler');
...
##################################################################################
package HookManager;
our @ISA = qw(ViewBase HookManagerOperations);

VIMRuntime::make_get_set('HookManager');
...
##################################################################################
package MediaAnalysisManager;
our @ISA = qw(ViewBase MediaAnalysisManagerOperations);

VIMRuntime::make_get_set('MediaAnalysisManager');
...
VIMRuntime::make_get_set('VirtualMachine', 'capability', 'config', 'layout', 'layoutEx', 'storage', 'environmentBrowser', 'resourcePool', 'parentVApp', 'resourceConfig', 'runtime', 'guest', 'guestInstallManager', 'summary', 'datastore', 'network', 'snapshot', 'rootSnapshot', 'configLocked', 'guestHeartbeatStatus');
...
VIMRuntime::make_get_set('AlarmManager', 'defaultExpression', 'description', 'lastTriggerId');

our @property_list = (
   ['defaultExpression', 'AlarmExpression', 'true'],
   ['description', 'AlarmDescription', undef],
   ['lastTriggerId', undef, undef],
);
sub get_property_list {
   my $class = shift;
   my @super_list = $class->SUPER::get_property_list();
...
##################################################################################
package MethodProxyManager;
our @ISA = qw(ViewBase MethodProxyManagerOperations);

VIMRuntime::make_get_set('MethodProxyManager');
...
##################################################################################
package ApiProxyServiceManager;
our @ISA = qw(ViewBase ApiProxyServiceManagerOperations);

VIMRuntime::make_get_set('ApiProxyServiceManager');
...
##################################################################################
package HostHostAccessManager;
our @ISA = qw(ViewBase HostHostAccessManagerOperations);

VIMRuntime::make_get_set('HostHostAccessManager', 'lockdownMode');
...
##################################################################################
package HostHostUpdateProxyManager;
our @ISA = qw(ViewBase HostHostUpdateProxyManagerOperations);

VIMRuntime::make_get_set('HostHostUpdateProxyManager');
...
VIMRuntime::make_get_set('HostProfileManager', 'supportedCustomizationFormats');

our @property_list = (
   ['supportedCustomizationFormats', 'ExtendedElementDescription', 'true'],
);
sub get_property_list {
   my $class = shift;
   my @super_list = $class->SUPER::get_property_list();
...
##################################################################################
package CustomizationGuestInstallManager;
our @ISA = qw(ViewBase CustomizationGuestInstallManagerOperations);

VIMRuntime::make_get_set('CustomizationGuestInstallManager');
...
VIMRuntime::make_get_set('GuestOperationsManager', 'authManager', 'fileManager', 'processManager', 'guestUpdateAgent', 'guestWindowsRegistryManager', 'aliasManager');

our @property_list = (
   ['authManager', 'GuestAuthManager', undef],
   ['fileManager', 'GuestFileManager', undef],
   ['processManager', 'GuestProcessManager', undef],
   ['guestUpdateAgent', 'GuestUpdateAgent', undef],
...
##################################################################################
package GuestUpdateAgent;
our @ISA = qw(ViewBase GuestUpdateAgentOperations);

VIMRuntime::make_get_set('GuestUpdateAgent');
...
##################################################################################
package ApiHooksCallbackHandlerOperations;
sub ExecutePreCallback {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ExecutePreCallback', %args));
   return $response
}

sub ExecutePostCallback {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ExecutePostCallback', %args));
   return $response
}
...
sub DVSReconfigureOverlayInstance_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DVSReconfigureOverlayInstance_Task', %args));
   return $response
}

sub DVSReconfigureOverlayInstance {
   my ($self, %args) = @_;
   return $self->waitForTask($self->DVSReconfigureOverlayInstance_Task(%args));
}
...
sub DVSQueryAvailableOverlayClass {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DVSQueryAvailableOverlayClass', %args));
   return $response
}
...
sub DVSFetchPortDb {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DVSFetchPortDb', %args));
   return $response
}

sub DVSClearPortDbEntry_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DVSClearPortDbEntry_Task', %args));
   return $response
}

sub DVSClearPortDbEntry {
   my ($self, %args) = @_;
   return $self->waitForTask($self->DVSClearPortDbEntry_Task(%args));
}
...
##################################################################################
package HookManagerOperations;
sub DeclareExtensionAsHookingService {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DeclareExtensionAsHookingService', %args));
   return $response
}

sub RemoveExtensionAsHookingService {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RemoveExtensionAsHookingService', %args));
   return $response
}

sub AcquireMethodHookForExtension {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('AcquireMethodHookForExtension', %args));
   return $response
}

sub ReleaseMethodHookForExtension {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ReleaseMethodHookForExtension', %args));
   return $response
}

sub UpdatePreCallbackResult {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdatePreCallbackResult', %args));
   return $response
}
...
sub QuerySystemResourceUsage {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('QuerySystemResourceUsage', %args));
   return $response
}
...
##################################################################################
package MediaAnalysisManagerOperations;
sub RecognizeInstaller {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RecognizeInstaller', %args));
   return $response
}
...
sub MountToolsInstallerImage {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('MountToolsInstallerImage', %args));
   return $response
}
...
sub UpgradeToolsFromImage_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpgradeToolsFromImage_Task', %args));
   return $response
}

sub UpgradeToolsFromImage {
   my ($self, %args) = @_;
   return $self->waitForTask($self->UpgradeToolsFromImage_Task(%args));
}
...
sub SetDisplayTopologyModes {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('SetDisplayTopologyModes', %args));
   return $response
}
...
sub UnlockVM {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UnlockVM', %args));
   return $response
}
...
sub QueryVRMPolicy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('QueryVRMPolicy', %args));
   return $response
}

sub UpdateVRMPolicy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateVRMPolicy', %args));
   return $response
}
...
##################################################################################
package MethodProxyManagerOperations;
sub RegisterMethodHandler {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RegisterMethodHandler', %args));
   return $response
}

sub UnregisterMethodHandler {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UnregisterMethodHandler', %args));
   return $response
}

sub RegisterObjectHandler {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RegisterObjectHandler', %args));
   return $response
}

sub UnregisterObjectHandler {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UnregisterObjectHandler', %args));
   return $response
}

sub RegisterEntityHandler {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RegisterEntityHandler', %args));
   return $response
}

sub UnregisterEntityHandler {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UnregisterEntityHandler', %args));
   return $response
}
...
##################################################################################
package ApiProxyServiceManagerOperations;
sub ApiProxyRegisterService {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ApiProxyRegisterService', %args));
   return $response
}

sub ApiProxyUnregisterService {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ApiProxyUnregisterService', %args));
   return $response
}

sub ApiProxyDisableService {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ApiProxyDisableService', %args));
   return $response
}

sub ApiProxyEnableService {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ApiProxyEnableService', %args));
   return $response
}

sub ApiProxyIsEnabled {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ApiProxyIsEnabled', %args));
   return $response
}

sub ApiProxyListServices {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ApiProxyListServices', %args));
   return $response
}
...
##################################################################################
package HostHostAccessManagerOperations;
sub RetrieveAccessEntries {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveAccessEntries', %args));
   return $response
}
...
sub QueryDcuiAccess {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('QueryDcuiAccess', %args));
   return $response
}

sub UpdateDcuiAccess {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateDcuiAccess', %args));
   return $response
}
...
##################################################################################
package HostHostUpdateProxyManagerOperations;
sub ReconfigureHostUpdateProxy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ReconfigureHostUpdateProxy', %args));
   return $response
}

sub RetrieveHostUpdateProxyConfig {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveHostUpdateProxyConfig', %args));
   return $response
}
...
sub RetrieveMessageBusProxyInfo {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveMessageBusProxyInfo', %args));
   return $response
}

sub ConfigureMessageBusProxy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ConfigureMessageBusProxy', %args));
   return $response
}

sub UnconfigureMessageBusProxy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UnconfigureMessageBusProxy', %args));
   return $response
}

sub StartMessageBusProxy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('StartMessageBusProxy', %args));
   return $response
}

sub StopMessageBusProxy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('StopMessageBusProxy', %args));
   return $response
}

sub ReloadMessageBusProxy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ReloadMessageBusProxy', %args));
   return $response
}
...
sub UpdateIpSecConfig {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateIpSecConfig', %args));
   return $response
}

sub UpdateConsoleIpSecConfig {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateConsoleIpSecConfig', %args));
   return $response
}
...
sub ExportHostProfileCustomizations_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ExportHostProfileCustomizations_Task', %args));
   return $response
}

sub ExportHostProfileCustomizations {
   my ($self, %args) = @_;
   return $self->waitForTask($self->ExportHostProfileCustomizations_Task(%args));
}

sub ImportHostProfileCustomizations_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ImportHostProfileCustomizations_Task', %args));
   return $response
}

sub ImportHostProfileCustomizations {
   my ($self, %args) = @_;
   return $self->waitForTask($self->ImportHostProfileCustomizations_Task(%args));
}
...
##################################################################################
package CustomizationGuestInstallManagerOperations;
sub PrepareForUnattendedInstall {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('PrepareForUnattendedInstall', %args));
   return $response
}

sub CleanupAfterUnattendedInstall {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('CleanupAfterUnattendedInstall', %args));
   return $response
}
...
sub QueryGuestOperationsDisabledMethods {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('QueryGuestOperationsDisabledMethods', %args));
   return $response
}
...
##################################################################################
package GuestUpdateAgentOperations;
sub RetrieveGuestUpdateAgentConfigValue {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveGuestUpdateAgentConfigValue', %args));
   return $response
}

sub UpdateGuestUpdateAgentConfigValue {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateGuestUpdateAgentConfigValue', %args));
   return $response
}

sub InitiateGuestUpdateAgentProductInfoQuery {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('InitiateGuestUpdateAgentProductInfoQuery', %args));
   return $response
}

sub InitiateGuestUpdateAgentProductInstall {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('InitiateGuestUpdateAgentProductInstall', %args));
   return $response
}

sub RetrieveGuestUpdateAgentJobStatus {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveGuestUpdateAgentJobStatus', %args));
   return $response
}

sub RetrieveGuestUpdateAgentJobResults {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveGuestUpdateAgentJobResults', %args));
   return $response
}
